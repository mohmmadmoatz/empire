...
class Read extends Component
{
    ...
    protected $listeners = ['incomeDeleted'];

    public $sortType;
    public $sortColumn;

    public function incomeDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.income.read', [
            'incomes' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Income')) ]);
    }
}
