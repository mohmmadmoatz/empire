...
class Read extends Component
{
    ...
    protected $listeners = ['outpaymentDeleted'];

    public $sortType;
    public $sortColumn;

    public function outpaymentDeleted(){
        // Nothing ..
    }
    ...
    {
        $data = OutPayment::query();

        $instance = getCrudConfig('outpayment');
        ...
        return view('livewire.admin.outpayment.read', [
            'outpayments' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('OutPayment')) ]);
    }
}
