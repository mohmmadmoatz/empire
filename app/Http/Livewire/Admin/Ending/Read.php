...
class Read extends Component
{
    ...
    protected $listeners = ['endingDeleted'];

    public $sortType;
    public $sortColumn;

    public function endingDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.ending.read', [
            'endings' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Ending')) ]);
    }
}
