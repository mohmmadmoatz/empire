<tr x-data="{ modalIsOpen : false }">
    ...
    @if(getCrudConfig('customer')->delete or getCrudConfig('customer')->update)
        <td>
            ...
            @if(getCrudConfig('customer')->update)
                <a href="@route(getRouteName().'.customer.update', ['customer' => $customer->id])" class="btn text-primary mt-1">
                    <i class="icon-pencil"></i>
                </a>
            @endif

            @if(getCrudConfig('customer')->delete)
