        ...
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded" style="background-color: #e9ecef!important;">
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.home')" class="text-decoration-none">{{
                        __('Dashboard') }}</a></li>
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.expense.read')"
                        class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('Expense')) }}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class='form-group'>
                        ...
                        <input x-data x-mask:dynamic="$money($input)"   wire:model.lazy='pay'
