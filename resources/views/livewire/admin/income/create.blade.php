<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Income') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                ...
                <input type="checkbox" name="" id="" wire:model="isPerctange">ادخال النسبة تلقائيا
                
            </div>

            @if($isPerctange && $project_id)
            <!-- Percentage Input -->
            <div class='form-group'>
                <label for='inputpercentage' class='col-sm-2 control-label'> {{ __('Percentage') }}</label>
                <input readonly wire:model.lazy = "perctange" type='text' class="form-control">
